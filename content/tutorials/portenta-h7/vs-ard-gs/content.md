...
### 1. The Basic Setup
Connect the Vision Shield to your Portenta H7 as shown in the figure. The top and bottom high density connecters are connected to the concurrent ones on the underside of the H7 board. Plug in the H7 to your computer using the USB C cable. 
